...
async function loadRankingSection() {
    ...
    try {
        const response = await fetch('/src/components/ranking/ranking-component.fragment?v=20260629-ranking-redesign-v6', { redirect: 'error' });
        if (!response.ok) {
        ...
        script.src = '/src/components/ranking/ranking-component.js?v=20260629-ranking-redesign-v6';
        script.onload = () => {
